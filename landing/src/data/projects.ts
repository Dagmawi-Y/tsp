...
export const allProjects: Project[] = [
  ...
  },
  {
    id: '2',
    title: 'E-Self',
    description: 'E-Self is an online learning platform designed to teach students in an accessible and easy way while enabling teachers to work remotely on the platform.',
    briefDescription:
        `E-Self opens doors to quality education for every Ethiopian learner
    ...
    highlights: [
      ...
      'Professionally Structured Courses',
        'High-quality lectures delivered by expert professionals in a clear, step-by-step format.',
